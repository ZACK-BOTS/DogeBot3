...
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('[DOGE BOT]'), color('Zack Bot Is Online', 'aqua'))
	...
	DogeXeonOP.browserDescription = [ 'Subscribe Zack', 'chrome', '3.0' ]
    DogeXeonOP.on('qr', () => {
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `𝙕𝙖𝙘𝙠 𝙈𝙤𝙙𝙯`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `𝙕𝙖𝙘𝙠 𝘽𝙤𝙩`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
